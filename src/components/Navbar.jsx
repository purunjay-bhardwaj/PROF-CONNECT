...
const NAV_LINKS = [
  ...
  { to: '/explore', label: 'Publications', pathKey: '/publications'  },
  { to: '/explore', label: 'Network',      pathKey: '/network'       },
]
      ...
      <div className="flex justify-between items-center w-full px-6 py-4 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-1">
            {NAV_LINKS.map((link) => {
              const active = pathname === (link.pathKey ?? link.to)
              return (
                <Link
                  key={link.label}
                  to={link.to}
        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden lg:block group">
            ...
            <input
              className="bg-white/[0.05] border border-white/10 rounded-full pl-10 pr-4 py-2 text-sm w-64
                         focus:ring-1 focus:ring-primary/50 focus:bg-white/10 transition-all
          ...
          <Link to="/home" className="w-9 h-9 rounded-full border border-white/10 overflow-hidden hover:border-primary/50 transition-colors">
            <img
